    ...
    public static ArrayList<Earthquake> extractEarthquakes() {
        ...
        try {
            ...
            for (int i = 0; i < featuresArray.length(); i++) {
                ...
                JSONObject featuresArrayJSONObject = featuresArray.getJSONObject(i);
                JSONObject properties = featuresArrayJSONObject.getJSONObject("properties");
                ...
                //Log.e("Earthquake" + i, earthquakes.toString());
            }
